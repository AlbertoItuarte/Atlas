...
const AgregarMisRutinas = ({ isOpen, onClose, coachId }) => {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `http://192.168.1.75:5000/misrutinas/agregar`,
        {
          IdCoach: coachId,
  ...
  return (
    <View
      ...
      className={`flex justify-center h-screen space-y-6 items-center bg-black ${isOpen ? "absolute mt-14  w-full z-50" : "hidden"}`}
    >
...
export default AgregarMisRutinas;
